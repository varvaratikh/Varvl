...
const int SERVO_PIN1 = 6;//крайний
const int SERVO_PIN2 = 2;//подъем
...
void moveToCoordinates(ParsedCoordinates coords) {
  ...
  static int currentX = 1; // Начальная X координата
  static int currentY = 1; // Начальная Y координата

  const int steps = 15; // Количество промежуточных точек
